...
document-feature matrix (“dfm”) → the analytical unit in which perform analysis; text documents are organized in matrices, with original texts as rows and features as columns. 

![Document Feature Matrix](..\14-FedericoMammana-Quanteda-\DFM Pic.png)


“Features” are more generally defined than “terms”, as they may be raw terms, stemmed terms, terms without stopwords, etc.
...
```{r}
#default snowball collection (15 languages) 

#stopwords_getsources()  #to see other sources with different languages 

#stopwords_getlanguages(source): #to see language options of sources
